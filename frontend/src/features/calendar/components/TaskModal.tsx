      ...
      <div className="flex flex-col items-center">
        ...
        >
          <Form className="flex flex-col justify-center items-center align-center max-w-[350px] my-8">
            ...
            <Field label="Titlu:" name="title" component={AppFormField} />
            <Field
            ...
            <p className="flex flex-row justify-left w-full text-[14px] font-bold">
              Data:
            </p>

            <div className="flex flex-row">
              <div className="mr-2">
                <Field label="din:" name="date" component={AppFormField} />
              </div>
              <div className="mx-2">
                <Field
                  label="pana la:"
              ...
              <div className="ml-2">
                <Field label="repeta:" name="repeat" component={AppFormField} />
              </div>
            </div>
